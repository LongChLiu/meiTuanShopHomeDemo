//
//  TakeawayProductCardCell.swift
//  MeiTuanShopDemo
//
//  Created by 艺教星 on 2019/5/17.
//  Copyright © 2019 艺教星. All rights reserved.
//

import UIKit

class TakeawayProductCardCell: UITableViewCell {
    ...
    func setupViews(){
        ...
        productImgView.snp.makeConstraints { (make) in
            ...
            make.height.equalTo(4.0*(takeawayRight_W-20)/7)
        }
        ...
        let str = AppDefaultUtil.returnLineSpacing(Str: "这里是标题20字以内，最多两行，这里是标题20字以内，最多两行", lineCount: 4, alignment: NSTextAlignment.left)
        ...
        productNameLabel.snp.makeConstraints { (make) in
            make.left.equalTo(10)
            make.top.equalTo(productImgView.snp.bottom).offset(4)
            make.right.equalTo(-10)
        ...
        priceLabel.snp.makeConstraints { (make) in
            make.left.equalTo(productNameLabel)
            make.top.equalTo(productImgView.snp.bottom).offset(76)
            make.height.equalTo(14)
        }
        ...
        let discountImgView = UIImageView.init()
        ...
        //添加按钮
        addBT = UIButton.init(type: UIButton.ButtonType.custom)
        ...
        sellOutLab.textAlignment = NSTextAlignment.left
        ...
        warningIcon.image = kImage_Name("icon_info_gray")
